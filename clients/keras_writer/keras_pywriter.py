...
#Program to test publishing data to a neural network that is trained for doing the XOR operation. The remote program is writem in Keras and consumes data from the topic that is created in this program. XOR data is created using random library.
